...
ActiveRecord::Schema.define(:version => 20121106000801) do
  ...
  add_index "celebration_taggings", ["celebration_id"], :name => "index_celebration_taggings_on_celebration_id"
  add_index "celebration_taggings", ["tag_id"], :name => "index_celebration_taggings_on_tag_id"
